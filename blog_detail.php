...
if(isset($_SESSION["active_user"])){
    ...
    $isSaved = checkSaved($acc_el, "blogs", $uid);
    $isLiked = checkLiked($acc_el, "blogs", $uid);
}
?>
<body>
    <style type="text/css">
	...
	<div id="page-transitions" class="page-build light-skin highlight-blue">    
        ...
        <div id="sheet-options-3" class="menu-box menu-bottom bg-transparent">
            ...
            <?php if((int)$isLiked  == 0){ ?>
                <a href="blog_action.php?action=like&element=<?= $acc_el ?>&element_type=blogs" class="color-highlight button button-full button-rounded button-sm button-white uppercase ultrabold top-10">
            ...
            <?php if((int)$isSaved == 0){ ?>
                <a href="blog_action.php?action=save&element=<?= $acc_el ?>&element_type=blogs" class="color-highlight button button-full button-rounded button-sm button-white uppercase ultrabold top-10">
        ...
        <div id="menu-comment" data-height="90vh" class="menu-box menu-bottom">
            ...
            <div class="content top-20">
                        ...
                        <div class="accordion-content" id="accordion-11">
                            <div class="content">
                                <form action="blog_action.php" method="post">
                                    ...
                                    <input type="hidden" name="item_type" value="blogs" />
                ...
                <?php
                    ...
                    $upqr = "SELECT * FROM `user_elements_post` WHERE `item`='$acc_el' AND `item_type`='blogs'";
