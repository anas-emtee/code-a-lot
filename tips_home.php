...
<body>
    ...
    <div id="page-transitions" class="page-build light-skin highlight-blue">    
        ...
        <div class="page-content header-clear-medium ">
            <?php
            $con = Dbcon();
            $evpqr = "SELECT * FROM `tips` WHERE status='published'";
            ...
            <div class="blog-post-home">
                ...
                <div class="blog-post-stats">
                    ...
                    <a href="#"><i class="fa fa-eye color-blue-light"></i><?= $blog["views"] ?></a>
                ...
                <a href="tips_detail.php?tip_reference=<?= $blog["id"] ?>" class="blog-post-more bg-green-dark shadow-small"><i class="fa fa-angle-right"></i></a>
            </div>
