...
<body class="dark-edition">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      <?php 
        $page_navbar_title = "Start A new Blog";
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Start a New Blog</p>
                </div>
                <div class="card-body">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-9">
                            ...
                            <div class="form-group">
                              <label class="bmd-label-floating">Topics Covered In The Blog</label>
                              <input type="text" class="form-control" required="" name="topics" />
                              <small>Topic1, Topic2, Topic3</small>
                            </div>
