              ...
              <div class="col-sm-12" >
                <div class="btn-toolbar" role="toolbar">
                  ...
                  <div class="btn-group">
                    ...
                    <button title="Insert Object" onclick="insertBlock('p', '')" class="btn btn-primary"><span class="fa fa-align-center"></span></button>
                  </div>
                  <div class="btn-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2" style="min-height: 72vh; max-height: 72vh; overflow-y: scroll;">
                    ...
                    <?php
                      $con = Dbcon();
                      $query="select * from `tips_media` WHERE blog='$bid'";
