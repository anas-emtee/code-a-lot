            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <a href="../blog_preview.php?blog_reference=<?= $blog["id"] ?>" class="btn btn-info btn-round"><i class="fa fa-eye"></i></a>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <a href="blog_startup.php" class="btn btn-primary btn-round">Start New</a>
                </div>
              </div>
            </div>
